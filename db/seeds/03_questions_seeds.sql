...
(question, answer1, answer2, answer3, correct_answer, text_answer, quiz_id) 
VALUES (
...
VALUES (
  ...
  'Being the world’s first ever search engine',
  'answer2',
  'Being the world’s very first website', 9
);
